...
Uso (via Docker Compose — recomendado):
  ...
  2) docker compose exec app python seed_radar_combustivel.py

Uso (local, fora do Docker):
  1) docker compose up -d
  2) pip install -r requirements.txt
  3) MONGO_URI=mongodb://localhost:27017/?directConnection=true python seed_radar_combustivel.py

Variáveis de ambiente (opcional):
  MONGO_URI   (default: mongodb://mongo:27017/?directConnection=true)
